...
/** Comparable interface is mainly used to sort the arrays (or lists) of custom objects. Lists (and arrays)
 * of objects that implement Comparable interface can be sorted automatically by Collection.sort (and array.sort)
 */
